...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 z-10 flex items-center justify-between w-full px-4 py-4 text-white shadow-lg bg-gradient-to-r from-gray-600 to-gray-600">
            <h1 className="text-xl font-bold">CertiGenerate</h1>
            <nav>
